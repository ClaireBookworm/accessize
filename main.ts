  ...
  options = Object.assign(
    {
      ...
      input: prompt,
      instruction: `As a senior google software engineer, deduplicate & remove the DOM areas that have redundant elements, add style width and alt text attributes to images, and make the website more accessible for disabilities.`,
    },
    options || {}
  );
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let doTransform = async (text: string) => {
    try {
      ...
      el.stat.style.backgroundColor = "#27cc4d";
